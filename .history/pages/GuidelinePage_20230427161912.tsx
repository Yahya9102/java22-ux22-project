  ...
  return (
    <div className={styles.guidelinePage_body}>
      ...
      <fieldset className={styles.guideline_fieldset_bottom}>
        We stand firmly against hate speech of any kind. Failure in treating our
        community users with respect or engaging in either racism, homophobia,
        ableism, sexism or any other kind of discrimination, will result in your
        post being deleted and a warning.
      </fieldset>
    </div>
  )
}
