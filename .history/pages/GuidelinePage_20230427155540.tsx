      ...
      <div>
        ...
        <div className={styles.continer}>
          <div className={styles.guideline_rules_right}>
            ...
            <p>
              Please be kind and respectful to others. Harassment and bullying
              are not allowed - we're committed to creating a safe and welcoming
              space for everyone!
            </p>
          </div>
          ...
          <div className={styles.guideline_rules_left}>
            ...
            <p className={styles.guideline_p}>
              Please don't pretend to be someone else or create fake accounts -
              we may remove your posts and issue a warning. Feel free to be
              yourself and share your awesomeness with us!
            </p>
          </div>
